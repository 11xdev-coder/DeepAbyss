...
//
// UCLASS()
// class AChunk : public AChunkBase
// {
// 	GENERATED_BODY()
// 	
// public:	
...
// 	void GenerateMesh();
//
// 	void ApplyMesh() const; // pass mesh data to ProceduralMesh
//
// 	bool CheckIfTransparent(FVector Position) const; // check opaque or transparent block
//
