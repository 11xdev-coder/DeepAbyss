...
#include "HidePinsInBreakStructInteractiveTool.generated.h"


/**
 * Builder for UHidePinsInBreakStructInteractiveTool
 */
UCLASS()
class HIDEPINSINBREAKSTRUCT_API UHidePinsInBreakStructInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UHidePinsInBreakStructInteractiveTool
 */
UCLASS(Transient)
class HIDEPINSINBREAKSTRUCT_API UHidePinsInBreakStructInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UHidePinsInBreakStructInteractiveToolProperties();
...
/**
 * UHidePinsInBreakStructInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class HIDEPINSINBREAKSTRUCT_API UHidePinsInBreakStructInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UHidePinsInBreakStructInteractiveToolProperties> Properties;
