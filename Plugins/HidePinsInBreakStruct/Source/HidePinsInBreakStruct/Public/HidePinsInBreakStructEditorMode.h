...
#include "HidePinsInBreakStructEditorMode.generated.h"
 ...
 */
UCLASS()
class UHidePinsInBreakStructEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_HidePinsInBreakStructEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UHidePinsInBreakStructEditorMode();
	virtual ~UHidePinsInBreakStructEditorMode();
